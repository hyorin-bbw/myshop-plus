...
public class MybatisPlusGenerate {
     ...
     * 作者
     */
    private static final String AUTHOR = "hyorin";
     ...
     * JDBC 连接地址
     */
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/qfdmy?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
     ...
     * 包配置 - 父级目录
     */
    private static final String PACKAGE_PARENT = "com.hyorin.myshop.provider.api";
     ...
     * 要生成的表，用 `,` 分割
     */
    private static final String TABLES = "ums_admin";
    ...
    private static PackageConfig packageConfig() {
        ...
        // 设置模块的名字，比如 core，生成效果为 com.hyorin.core
